...
test('Color() instance (null)', () => {
  ok((new Color(null)) instanceof Color);
});

test('Color() instance (undefined)', () => {
...
test('Translate with channel setters', () => {
  deepEqual(Color({
    r: 0,
    g: 0,
    b: 0,
...
test('Should parse alphas in RGBA hex notation correctly', () => {
