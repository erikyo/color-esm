...
const parsers: COLOR_PARSERS[] = [
	...
	{ model: "rgb", regex: validators.rgb, parser: extract, converter: fromRgb },
	{ model: "hsl", regex: validators.hsl, parser: extract, converter: fromHsl },
	{ model: "lab", regex: validators.lab, parser: extract, converter: fromLab },
	{ model: "hwb", regex: validators.hwb, parser: extract, converter: fromHwb },
	{ model: "xyz", regex: validators.xyz, parser: extract, converter: fromXyz },
	{ model: "lch", regex: validators.lch, parser: extract, converter: fromLch },
	{
		model: "oklab",
